...
PICS = (environ.get('PICS', 'https://graph.org/vTelegraphBot-11-04-5 https://envs.sh/jem.jpg https://envs.sh/jeX.jpg')).split()
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/TownBus')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002062053288'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'TamilSupport')
